...
<head>
    ...
    <title>TITLE_VAR - Insurance Packages Network</title>
    <!-- Bootstrap CSS -->
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg bg-white sticky-top py-3 shadow-sm z-3">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="index.html">
                ...
                <div>
                    <span class="fw-bold fs-4 d-block lh-1 text-dark">Insurance Packages Network</span>
    ...
    <section class="page-header py-5 position-relative bg-primary overflow-hidden">
       ...
       <div class="container py-5 mt-4 text-center position-relative z-1 text-white">
           <span class="badge badge-custom px-4 py-2 mb-4 rounded-pill fw-medium fs-6 bg-white text-primary shadow-sm border border-light">Insurance Packages Network Protection</span>
    ...
    <section class="cta-section py-5 position-relative overflow-hidden bg-white mt-auto border-top border-light border-3">
        ...
        <div class="container position-relative z-1 py-5 text-center" style="max-width: 850px;">
            ...
            <div class="mt-4">
                <p class="small text-secondary mb-0">&copy; 2026 Insurance Packages Network. All Rights Reserved.</p>
            </div>
        </div>
    </section>
